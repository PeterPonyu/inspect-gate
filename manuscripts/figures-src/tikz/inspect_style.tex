...
% Text colour policy: axis titles, tick labels, legend *words*, and (via
% \panellabel) panel letters default to black — never grey / muted text.
% Decorative markers/lines may still use muted greys or semantic colours.
\pgfplotsset{
