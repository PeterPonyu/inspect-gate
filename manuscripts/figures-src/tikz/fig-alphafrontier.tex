...
% Width expand (panel 2.70→3.20in; right-col 3.30→3.68in): fill elsarticle
% preprint \linewidth (~360pt) under height budget; inter-column gap ~0.10in.
% Height: panel 1.82→1.88in (modest); keep ~0.40in row gutters.
% Local font bump (+1pt) so labels read larger once width-bound on page.
...
% Fig5: modest local overrides above house defaults (do not edit inspect_style).
\renewcommand{\figfont}{\fontsize{9}{11}\selectfont}
\renewcommand{\tickfont}{\fontsize{8}{9.5}\selectfont}
\renewcommand{\axislabelfont}{\fontsize{10}{12}\selectfont}
\renewcommand{\titlefont}{\fontsize{10}{12}\selectfont}
\renewcommand{\panellabelfont}{\fontsize{12}{14}\selectfont\bfseries}
...
% yshift 0.44in: clear a/b titles without top clip.
