...
\begin{axis}[
  inspect default,
  name=ax_a,
  width=2.58in, height=1.18in, at={(0.66in,3.00in)},
  xmin=-0.02, xmax=1.05,
  ymin=-4.20, ymax=0.20,
  xlabel={rate},
...
\begin{axis}[
  inspect default,
  name=ax_b,
  width=2.58in, height=1.18in, at={(3.22in,3.00in)},
  xmin=-0.03, xmax=1.03,
  ymin=-0.03, ymax=1.03,
...
% Shared a/b legend — horizontal, just above titles (clear of gutter letters).
% Parked above the title row so it never collides with titles or gutter letters.
\node[anchor=south, font=\tickfont, inner sep=0.5pt]
  at ($(ax_a.north)!0.5!(ax_b.north)+(0,16pt)$) {%
