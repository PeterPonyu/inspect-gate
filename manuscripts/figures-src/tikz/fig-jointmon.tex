...
% Height budget: a|b ~1.80in; c/d modestly taller (~1.18 / ~1.08) so the
% wide bottom stack shares more vertical space; legends @26pt;
...
\begin{axis}[
  inspect default,
  name=ax_a,
  width=2.58in, height=1.80in, at={(0.66in,2.98in)},
  xmin=-0.02, xmax=1.05,
  ymin=-4.20, ymax=0.20,
  xlabel={rate},
...
\begin{axis}[
  inspect default,
  name=ax_b,
  width=2.58in, height=1.80in, at={(3.22in,2.98in)},
  xmin=-0.03, xmax=1.03,
  ymin=-0.03, ymax=1.03,
...
\begin{axis}[
  inspect default,
  name=ax_c,
  width=5.14in, height=1.18in, at={(0.66in,1.28in)},
  xmin=-9.5, xmax=11.0,
  ymin=-9.5, ymax=9.5,
...
\begin{axis}[
  inspect default,
  name=ax_d,
  width=5.14in, height=1.08in, at={(0.66in,0.02in)},
