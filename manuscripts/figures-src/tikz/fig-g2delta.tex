...
%   a/b shared legend — TikZ node @34pt above the a/b midline
%   a/b row @ 3.30in — clears c/d legend tops (~2.94) + a/b rotated x-labels
...
% Panel a: MVTec tiles
% a/b at 3.30in: c/d north=2.35; legend south@34pt≈2.82; legend top≈2.96;
% ~0.34in left for a/b rotated x-labels hanging into the row gutter.
\begin{axis}[
  inspect default,
  name=axa, width=2.55in, height=1.15in, at={(0.55in,3.30in)},
...
\begin{axis}[
  inspect default,
  name=axb, width=1.70in, height=1.15in, at={(3.55in,3.30in)},
