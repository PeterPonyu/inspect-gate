...
%   a/b row @ 2.92in — clears c/d legend tops (~2.94) with x-labels tucked into gutter
...
% Panel a: MVTec tiles
% a/b at 2.92in: c/d north=2.35; c/d legend south@34pt≈2.82; top≈2.96;
% ~0.04in nominal axis-to-legend clearance; rotated x-labels tuck into the gutter.
\begin{axis}[
  inspect default,
  name=axa, width=2.55in, height=1.15in, at={(0.55in,2.92in)},
...
\begin{axis}[
  inspect default,
  name=axb, width=1.70in, height=1.15in, at={(3.55in,2.92in)},
