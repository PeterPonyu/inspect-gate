...
%   legend @ 1.28  — horizontal row, clear of the title/letter row
%   title  @ 1.02  — tight to the axis top (b/c); panel letters sit on this
%                    same row in the left gutter so they never meet the legend
...
% Panel a: dot strip (gate hollow / CRC filled) — legend only, no title
\begin{axis}[
  inspect default,
...
\input{../out/crcbaseline-panel-a.tex}
\end{axis}
\crclabel{axa}{a}
...
\input{../out/crcbaseline-panel-b.tex}
\end{axis}
\crclabel{axb}{b}

% Panel c: G2 certified per-backbone bars
% Short title shares the title row with the panel letter (letter in left gutter).
\begin{axis}[
  inspect default,
  ...
  % Title shares the 1.02 row with the letter but is nudged right to clear it.
  title style={at={(0.62,1.02)}, anchor=south, font=\titlefont},
  crc/legend above,
  title={CRC: 0 certified},
  clip=false,
]
\input{../out/crcbaseline-panel-c.tex}
