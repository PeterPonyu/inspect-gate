...
\author{Zeyu Fu\thanks{TODO-USER: affiliation and correspondence.}}
\date{\today}
...
\begin{itemize}
  ...
  \item \textbf{V1 tier-2 as a verdict.} Now graded (Section~\ref{sec:tier2verdict},
        Table~\ref{tab:tier2}): under amendments A1/A2/A3 the MVTec escaped axis fails in $115/130$
...
not by itself carry a permanent identifier), the source will be maintained on GitHub as the
development mirror and archived on Zenodo under a persistent DOI at submission.
\todo{GitHub repository URL and Zenodo DOI for the frozen score dumps, analysis code, and
preregistration archive (user credentials/deposit pending).}
